...
public class Entity {
	...
	//public static BufferedImage MOEDA = Game.spritesheet.getSprite(0, 80, 16, 16);
	//public static BufferedImage MOEDA2 = Game.spritesheet.getSprite(16, 80, 16, 16);
	...
	public static BufferedImage GUN_DAMAGED_RIGHT = Game.spritesheet.getSprite(0, 32, 16, 16);
	public static BufferedImage GUN_DAMAGED_LEFT = Game.spritesheet.getSprite(16, 32, 16, 16);
	
	public static BufferedImage FLOR = Game.spritesheet.getSprite(32, 32, 16, 16);
